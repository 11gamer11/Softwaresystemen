...
*/
public abstract class MainServerProtocol extends CommonProtocol {
	/**
	...
	*/
	...
	/**
	* Antwoord op de handshake van de client. 
	* Moet altijd het eerst verzonden commando zijn, met uitzondering van errors.
	...
	*/
	...
	/**
	* Antwoord op de handshake van de client. Moet altijd het eerst verzonden commando zijn,
	* met uitzondering van errors.
	...
	* @requires Dat de nonce gesigned is met de juiste public-key
	* 			volgens ss-security.student.utwente.nl
	* @throws IOException
	*/
    public abstract void authOk() throws IOException;

	/**
	* Commando om de client te laten weten dat hij iets fout heeft gedaan,
	* waardoor de verbinding moet worden verbroken.
	...
	*/
	...
	/**
	* Commando om de client te laten weten dat er óf een nieuw spel is,
	* óf dat er een spel is veranderd in status. Clients krijgen een serie van deze commando's
	* na de handshake om zo een lijst van alle spellen op te bouwen.
	* Als er daarna iets verandert aan het aantal spelers
	* of dat het spel is begonnen moet de server weer een update sturen.
	* @requires Dat de handshake is gedaan.
	* @requires Dat óf het spel in hasStarted-status is veranderd,
	* 			óf in aantal spelers is veranderd, óf dat de client nog niet de volledige lijst
	* 			met spellen heeft ontvangen direct na de handshake.
	...
	*/
    public abstract void start(String playerOne,
    								String playerTwo, String playerThree) throws IOException;
	...
	*/
    public abstract void start(String playerOne, String playerTwo,
    							String playerThree, String playerFour) throws IOException;
	...
	* Eventueel zijn er winnaars als het spel helemaal is voltooid.
	* De server mag bepalen wat er gebeurt als er meerdere mensen dezelfde
	* score hebben.
	* @requires Dat de handshake is gedaan.
	* @requires Dat de speler in een spel zit.
	* @requires Dat het spel is gestart.
	* @requires Dat: Als het spel is gestart:
	* 			ofwel het spel is afgelopen volgens de regels van de server
	* 			ofwel één van de mensen is weggegaan
	...
	*/
	public abstract void challenge(String challenger,
										String other1, String other2) throws IOException;
	...
	*/
	public abstract void challenge(String challenger, String other1,
										String other2, String other3) throws IOException;
	
	/**
	* Commando om mensen die in een uitdaging zitten op de hoogte te stellen van
	* de status van de uitgedaagden.
	* @requires Dat de handshake is gedaan.
	...
	* @requires Dat de handshake is gedaan
	* @requires Dat ófwel er een client bijkomt, ófwel er een client weggaat,
	*			ófwel dat de client de lijst met mensen nog niet in zijn geheel heeft ontvangen
	*			na de lijst van spellen. Dit laatste is geen requirement voor servers zonder chat.
	*/
